...
from manufold.adk import ManugenAIBaseAgent
...
coordinator_agent = CoordinatorAgent(
    sub_agents_cond=[
        (
            figure_agent,
            lambda user_input: (
                user_input.inline_data is not None
        ...
        (
            citation_agent,
            lambda user_input: (
                user_input.text is not None and "$CITATION_REQUEST$" in user_input.text
            ),
        ),
        (
            review_agent,
            lambda user_input: (
                user_input.text is not None and "$REFINE_REQUEST$" in user_input.text
            ),
        ),
        (
            repo_agent,
            lambda user_input: (
                user_input.text is not None and "$REPO_REQUEST$" in user_input.text
            ),
        ),
        (
