...
1. Figures may be uploaded (it works with PNG format) by clicking on the "Toggle Attachments" button at the top left. If you want to download figures for the example, please see [here](https://github.com/pivlab/manufold/tree/main/frontend/public/example).
...
https://github.com/pivlab/manufold/issues/11
